...
execute_process(
  COMMAND "/usr/bin/git" show-ref "3.3.3"
  WORKING_DIRECTORY "/home/pdell/dev/viz3d/glfw/src/glfw"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/pdell/dev/viz3d/glfw/src/glfw'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/pdell/dev/viz3d/glfw/src/glfw'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
