...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v0.1.34"
  WORKING_DIRECTORY "/home/pdell/dev/viz3d/glad/src/glad"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/pdell/dev/viz3d/glad/src/glad'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/pdell/dev/viz3d/glad/src/glad'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
